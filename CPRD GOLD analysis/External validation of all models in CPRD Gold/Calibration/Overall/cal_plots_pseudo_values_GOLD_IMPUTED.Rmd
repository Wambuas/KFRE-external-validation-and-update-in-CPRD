...
s2_KFREUK1 = 0.9994368
s5_KFREUK1 = 0.9983078

x = kfre_uk1 %>% dplyr::mutate(
  ...
  ### 2 years
  #original KFRE
  LP = ((0.173393276 *(age1-1.4169216))+
        (-4.736050324 *(age2-0.4124569))
                  + (0.555522277*sex)
                  + (2.224911285*(egfr1+0.6918350))
                  +(-19.359795740*(egfr2-0.7121481))
                  + (0.005558573*(ACR1-0.8443034))
                    +(0.376014346*(ACR2+2.1872091))),
   ### 2 years
  score_2yrs_KFREUK1 = (1-(s2_KFREUK1 ^ exp(LP))),
   ### 5 years
  score_5yrs_KFREUK1 = (1-(s5_KFREUK1 ^ exp(LP))),
...
x = kfre_uk2 %>% dplyr::mutate(
  ...
  asian = ifelse(ethnicity=="South Asian",1,0),
  mixed = ifelse(ethnicity=="Mixed race",1,0),
  others = ifelse(ethnicity=="Others",1,0),
  unknown = ifelse(ethnicity=="Unknown",1,0),
  
  diabetic = ifelse(diabetic=="1",1,0),
  
  ### 2 years
  #original KFRE
  LP = ((0.302900388  *(age1-1.4169216))+
        (-4.225650207 *(age2-0.4124569))
                  + (0.522087156 *sex)
                  + (2.200144187 *(egfr1+0.6918350))
                  +(-19.309421031*(egfr2-0.7121481))
                  + (0.005672024*(ACR1-0.8443034))
                  + (0.342234580*(ACR2+2.1872091))
                  + (0.785136320*(diabetic)) 
                  +  (0.227325295*(black))
                   +  (0.310993852*(asian))
                     + (0.020676575*(mixed))
                    + (0.327495457*(others))
                    +  (-1.001371116*(unknown))),
   ### 2 years
  score_2yrs_KFREUK2 = (1-(s2_KFREUK2 ^ exp(LP))),
   ### 5 years
  score_5yrs_KFREUK2 = (1-(s5_KFREUK2 ^ exp(LP))),
...
combined_cal_data = combined_cal_data %>% dplyr::mutate(
  ...
  Model2 = recode(Model, "Benchmark"="Benchmark","KFREUK1"="Model 1","KFREUK2"="Model 2"),
...
p1 = ggplot(figure_5_data1, aes(
  ...
  scale_color_manual(values = c(
    "Benchmark" = "#4D4D4D",  # dark-grey
    "Model 1"   = "#56B4E9" ,  # sky blue
    "Model 2"   = "#E69F00"  # orange

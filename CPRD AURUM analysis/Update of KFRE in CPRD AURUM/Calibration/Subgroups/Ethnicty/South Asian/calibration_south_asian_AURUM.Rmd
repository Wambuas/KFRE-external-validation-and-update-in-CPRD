...
benchmark = subset(benchmark,benchmark$ethnicity=="South Asian")
```
...
```{r}
kfre_uk1 = subset(kfre_uk1,kfre_uk1$ethnicity=="South Asian")
```
...
```{r}
kfre_uk2 = subset(kfre_uk2,kfre_uk2$ethnicity=="South Asian")
```

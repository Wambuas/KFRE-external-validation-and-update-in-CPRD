...
benchmark = subset(benchmark,benchmark$ethnicity=="Missing")
```
...
```{r}
kfre_uk1 = subset(kfre_uk1,kfre_uk1$ethnicity=="Missing")
```
...
```{r}
kfre_uk2 = subset(kfre_uk2,kfre_uk2$ethnicity=="Missing")
```

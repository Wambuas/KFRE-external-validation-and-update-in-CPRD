...
benchmark = subset(benchmark,benchmark$ethnicity=="Others")
```
...
```{r}
kfre_uk1 = subset(kfre_uk1,kfre_uk1$ethnicity=="Others")
```
...
```{r}
kfre_uk2 = subset(kfre_uk2,kfre_uk2$ethnicity=="Others")
```
